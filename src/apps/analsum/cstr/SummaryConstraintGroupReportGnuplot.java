...
public class SummaryConstraintGroupReportGnuplot
	...
	protected void onInit(
		...
		filenameBaseBuilder.append(String.format("cstr_grp_%s_%d_%s",
				groupperName, groupSize, attributeSelector.getName()));
